...
class LoginPage(BasePage):
    ...
    def register_new_user(self,email, password):
        ...
        password_link=self.browser.find_element(*LoginPageLocators.REGISTRATION_PASSWORD)
        password_link.send_keys(password)
        password_confirmation=self.browser.find_element(*LoginPageLocators.REGISTRATION_PASSWORD_CONFIRMATION)
